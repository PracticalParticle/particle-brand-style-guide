...
function getPrintPageStyle(logoDataUrl: string): string {
  ...
  *, *::before, *::after { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  html, body { font-family: system-ui, sans-serif; color: #0a0a0a; font-size: 12pt; line-height: 1.5; margin: 0; background: #fff !important; }
  body > * { position: static !important; left: auto !important; width: 100% !important; background: #fff !important; }
  .doc-print-body { background: #fff !important; }
  .doc-print-table { width: 100%; border-collapse: collapse; background: #fff !important; }
  .doc-print-table td { background: #fff !important; }
  .doc-print-table thead td { background: #fff !important; }
  .doc-print-table tfoot td { background: #fff !important; }
  ...
  .doc-print-body h1 { font-size: 1.5em; margin: 0 0 0.75em; }
  .doc-print-body h2 { font-size: 1.25em; margin: 1.25em 0 0.5em; }
  .doc-print-body h2:first-of-type { margin-top: 0; }
  .doc-print-body h3 { font-size: 1.1em; margin: 1em 0 0.4em; }
  ...
  .doc-print-body th { background: #f0f1f3 !important; font-weight: 600; }
  .doc-print-body a { text-decoration: underline; color: #2563eb; }
  .doc-print-header-inner { display: flex; align-items: center; gap: 14px; }
  .doc-print-header .doc-print-logo { flex-shrink: 0; width: 44px; height: 36px; color: #0a0a0a; background-image: url("${logoDataUrl}"); background-repeat: no-repeat; background-position: left center; background-size: contain; }
  ...
  .doc-print-header-title { font-size: 11pt; font-weight: 600; color: #0a0a0a; }
  .doc-print-header-subtitle { font-size: 9pt; color: #525252; }
  .doc-print-footer-inner { display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 8px; }
  .doc-print-footer a { color: #374151; text-decoration: underline; }
  .doc-print-footer a:hover { color: #0a0a0a; }
  .doc-print-body .doc-card { border: 1px solid #e5e7eb; border-radius: 8px; padding: 1rem 1.25rem; margin: 0.75em 0; background: #fafbfc !important; }
  .doc-print-body .doc-callout { border-left: 4px solid #0a0a0a; padding: 0.75rem 1rem; margin: 0.75em 0; background: #f0f1f3 !important; font-size: 10pt; line-height: 1.4; }
  ...
  .doc-print-body .doc-table { width: 100%; margin: 0.75em 0; overflow: hidden; border-radius: 8px; border: 1px solid #e5e7eb; }
  .doc-print-body .doc-table table { border-collapse: collapse; width: 100%; font-size: 9pt; line-height: 1.35; }
  .doc-print-body .doc-table th, .doc-print-body .doc-table td { border: 1px solid #e5e7eb; padding: 6px 8px; text-align: left; vertical-align: top; }
  .doc-print-body .doc-table th { background: #fafbfc !important; color: #0a0a0a; font-weight: 600; padding: 10px 12px; }
  .doc-print-body .doc-table thead th:first-child { border-top-left-radius: 7px; }
  .doc-print-body .doc-table thead th:last-child { border-top-right-radius: 7px; }
  .doc-print-body .doc-table tbody tr:last-child td:first-child { border-bottom-left-radius: 7px; }
  .doc-print-body .doc-table tbody tr:last-child td:last-child { border-bottom-right-radius: 7px; }
  .doc-print-body .doc-table tbody tr:nth-child(even) { background: #f9fafb !important; }
  .doc-print-body .doc-table tbody tr:hover { background: #f3f4f6 !important; }
...
function getLogoDataUrl(): string {
  const svgForPrint = logoSvgRaw.replace(/currentColor/g, '#0a0a0a')
      ...
      <Card variant="outlined" padding="lg">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_1.5fr]">
          ...
          <div className="rounded-control border border-border bg-white p-4 min-h-[320px] min-w-[32rem] overflow-auto">
            ...
            <div className="document-preview-pane text-sm text-text-primary bg-white [&_h1]:text-xl [&_h1]:font-semibold [&_h1]:mt-2 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:mt-3 [&_h3]:text-base [&_h3]:font-semibold [&_p]:my-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_table]:border-collapse [&_th]:border [&_th]:border-border [&_td]:border [&_td]:border-border [&_th]:px-2 [&_td]:px-2 [&_th]:bg-bg-tertiary [&_a]:underline [&_a]:text-primary [&_.doc-card]:rounded-lg [&_.doc-card]:border [&_.doc-card]:border-border [&_.doc-card]:bg-bg-tertiary/50 [&_.doc-card]:p-4 [&_.doc-card]:my-3 [&_.doc-callout]:border-l-4 [&_.doc-callout]:border-l-primary [&_.doc-callout]:bg-bg-tertiary/50 [&_.doc-callout]:py-2 [&_.doc-callout]:px-3 [&_.doc-callout]:my-3 [&_.doc-callout]:text-xs [&_.doc-directive-fence]:!hidden [&_.doc-cards]:grid [&_.doc-cards]:gap-3 [&_.doc-cards]:w-full [&_.doc-cards]:items-start [&_.doc-cards>*:not(.doc-card)]:!hidden [&_.doc-cards_.doc-card]:my-0 [&_.doc-cards_.doc-card]:min-w-0 [&_.doc-cards-1]:grid-cols-1 [&_.doc-cards-2]:grid-cols-2 [&_.doc-cards-3]:grid-cols-3 [&_.doc-cards-4]:grid-cols-4 [&_.doc-cards-5]:grid-cols-5 [&_.doc-cards-6]:grid-cols-6 [&_.doc-cards-7]:grid-cols-7 [&_.doc-cards-8]:grid-cols-8 [&_.doc-table]:w-full [&_.doc-table_th]:bg-bg-tertiary [&_.doc-list]:pl-6 [&_.doc-list-compact]:pl-5 [&_.doc-list-compact_li]:my-0.5 [&_.doc-page-break]:block [&_.doc-page-break]:border-t [&_.doc-page-break]:border-dashed [&_.doc-page-break]:border-border [&_.doc-page-break]:my-4 [&_.doc-page-break]:py-2 [&_.doc-page-break]:text-center [&_.doc-page-break]:text-xs [&_.doc-page-break]:text-text-tertiary [&_.doc-page-break]:before:content-['Page_break']">
              <ReactMarkdown remarkPlugins={[remarkGfm, remarkDirective, remarkDocDirectives]}>{markdown}</ReactMarkdown>
            </div>
          </div>
        </div>
      </Card>
